...
export class ConferenceApp {
  ...
  appPages: PageInterface[] = [
    { title: 'Agenda', name: 'TabsPage', component: TabsPage, tabComponent: SchedulePage, index: 0, icon: 'calendar' },
    { title: 'Comentários', name: 'TabsPage', component: TabsPage, tabComponent: SpeakerListPage, index: 1, icon: 'contacts' },
  ...
  loggedOutPages: PageInterface[] = [
    ...
    { title: 'Suporte', name: 'SupportPage', component: SupportPage, icon: 'help' },
    { title: 'Inscreva-se', name: 'SignupPage', component: SignupPage, icon: 'person-add' }
  ];
  rootPage: any;
